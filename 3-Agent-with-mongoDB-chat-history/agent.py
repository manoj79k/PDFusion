...
from mongo_client import save_chat_to_mongo,get_chat_history,get_all_chats,render_chat_history,save_chat_to_mongo_without_user
import uuid
...
if query:
    with st.spinner("Generating answer..."):
        ...
        st.session_state.chat_history_ui.append(("assistant", answer))
          # ✅ Save to MongoDB
        save_chat_to_mongo_without_user(
